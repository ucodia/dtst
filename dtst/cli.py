...
from dtst.commands import analyze, augment, cluster, copy, curate, dedup, extract_faces, extract_frames, fetch, filter, frame, run, search, tag
...
cli.add_command(curate.cmd, "curate")
