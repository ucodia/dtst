...
This copies only images whose largest side is at least 1024px, have a blur metric score of 5 or above, and where the "microphone" detection score is below 0.25.
