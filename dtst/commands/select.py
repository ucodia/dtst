...
def cmd(
    ...
    cfg = _resolve_config(config, working_dir, parsed_from_dirs, to, move, min_size, min_blur, max_tag, min_tag)
    ...
    has_criteria = cfg.min_size is not None or cfg.min_blur is not None or cfg.max_tag or cfg.min_tag
